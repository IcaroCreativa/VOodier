            ...
            <form class="mt-6 border-t border-gray-400 pt-4">
                <div class='flex flex-wrap -mx-3 mb-6'>
                    <div class='w-full md:w-full px-3 mb-6'>
                        ...
                        <p id=email name=email value="" class='appearance-none block w-full bg-white text-gray-700 border border-gray-400 shadow-inner rounded-md py-3 px-4 leading-tight focus:outline-none  focus:border-gray-500' id='grid-text-1' type='text' placeholder='Enter email'  required> {{$user_data->email}}</p>
                    ...
                    <div class='w-full md:w-full px-3 mb-6'>
                        ...
                        <div class="flex-shrink w-full inline-block relative">
                            <p id=number_ads name=number_ads value="" class='appearance-none block w-full bg-white text-gray-700 border border-gray-400 shadow-inner rounded-md py-3 px-4 leading-tight focus:outline-none  focus:border-gray-500' id='grid-text-1' type='text' placeholder='Enter email' >post number user</p>
                            <div class="pointer-events-none absolute top-0 mt-3  right-0 flex items-center px-2 text-gray-600">
                    ...
                    <div class="personal w-full border-t border-gray-400 pt-4">
                        ...
                        <div class="flex items-center justify-between mt-4">
                            <div class='w-full md:w-1/2 px-3 mb-6'>
                                ...
                                <p id=first_name name=first_name value="" class='appearance-none block w-full bg-white text-gray-700 border border-gray-400 shadow-inner rounded-md py-3 px-4 leading-tight focus:outline-none  focus:border-gray-500' id='grid-text-1' type='text' placeholder='first name'  >{{$user_data->first_name}}</p>
                            </div>
                            <div class='w-full md:w-1/2 px-3 mb-6'>
                                <label for=last_name class='block uppercase tracking-wide text-white text-xs font-bold mb-2' >last name</label>
                                <p id=last_name name=last_name value="" class='appearance-none block w-full bg-white text-gray-700 border border-gray-400 shadow-inner rounded-md py-3 px-4 leading-tight focus:outline-none  focus:border-gray-500' id='grid-text-1' type='text' placeholder='Last name'  >{{$user_data->last_name}}</p>
                            </div>
                        </div>
                        <div class='w-full md:w-full px-3 mb-6'>
                            <label for=login class='block uppercase tracking-wide text-white text-xs font-bold mb-2'>Login</label>
                            <div class="flex-shrink w-full inline-block relative">
                            <p id=login name=login value="" class='appearance-none block w-full bg-white text-gray-700 border border-gray-400 shadow-inner rounded-md py-3 px-4 leading-tight focus:outline-none  focus:border-gray-500' id='grid-text-1' type='text' placeholder='Login'  >{{ucfirst(strtolower($user_data->login))}}</p>
                            <div class="pointer-events-none absolute top-0 mt-3  right-0 flex items-center px-2 text-gray-600">
                        ...
                        <div class='w-full md:w-full px-3 mb-6'>
                            ...
                            <div class="flex-shrink w-full inline-block relative">
                            <p id=phone_number name=phone_number value="" class='appearance-none block w-full bg-white text-gray-700 border border-gray-400 shadow-inner rounded-md py-3 px-4 leading-tight focus:outline-none  focus:border-gray-500' id='grid-text-1' type='text' placeholder='Phone number'  >{{$user_data->phone_number}}</p>
                            <div class="pointer-events-none absolute top-0 mt-3  right-0 flex items-center px-2 text-gray-600">
                        ...
                        <div class="flex justify-center ">
                            <button href="{{route('user_account_update')}}" class="w-1/6 appearance-none hover:bg-gradient-to-r from-red-900 via-red-600 to-red-500 hover:text-white focus:bg-red-600  focus:bg-red-600  bg-white text-red-600 font-medium px-2 py-1 shadow-sm border border-white rounded-md mr-3" type="submit">Modify</button>
                        </div>
                    </div>
                </div>
            </form>
