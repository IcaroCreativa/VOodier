...
{{-- {{$ads=[
  ['title'=>"Portable Hp 225",
   ...
   'category'=>'Multimedia',
   'price'=>'150',
   'description'=>"Ordinateur en parfait etat de marche acheter en 2019. Bateries ok. Fonctionnel",
   'zip'=>"29120",
   'location'=>"Malaga"
