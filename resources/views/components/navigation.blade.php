...
<header aria-label="Site Header" class="shadow-lg ">
  ...
  {{-- --------bouton loupe------ md et sm ----------- --}}
      ...
      <div class="flex border-gray-300 -mt-4">
        ...
        <a href="{{route('create_post')}}" class="flex items-center rounded-lg  px-4 p-1 text-gray-600 hover:bg-gradient-to-r from-red-900 via-red-600 to-red-500 hover:text-white">
